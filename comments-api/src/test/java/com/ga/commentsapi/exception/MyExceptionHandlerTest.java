...
public class MyExceptionHandlerTest {
    ...
    @Test
    public void handleCommentNotExistException() {
        dummyErrorResponse.setHttpStatus(HttpStatus.NOT_FOUND);
        dummyErrorResponse.setTimestamp(timestamp);

        ResponseEntity<ErrorResponse> actual = myExceptionHandler.handleCommentNotExistException(new CommentNotExistException("test"));
